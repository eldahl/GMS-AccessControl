...
pinMode(A2,INPUT_PULLUP); //HJT
pinMode(A4,OUTPUT); // anvendes til dør relæ HJT
pinMode(A3,OUTPUT); //anvendes til dør relæ HJT
  ...
  mfrc522.PCD_SetAntennaGain(mfrc522.RxGain_max);  // fjernet ****************************HJT
...
while(digitalRead(A2) == 0  && ((tid + 3500) > millis() ) ){} // venter på kontakt i stillingt neutral
 ...
 // skifter retning til næste gang
if (a==1){
  a=0;
  b=1;
}
